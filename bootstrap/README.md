# Demo Terraform AWS Infrastructure Mono Repo: Backend Bootstrap  

## Overview

AWS terraform backend bootstrap for Infrastructure. This will contain resources used for managing the Terraform Backend State.  
